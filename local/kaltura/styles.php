...
#overlay{ position: fixed; top: 0; left: 0; z-index: 199; width: 100%; height: 100%; background:url('<?php echo $CFG->wwwroot.'/local/kaltura/'; ?>images/trans-bg.png') 0 0 repeat; cursor: wait; }
...
#divUserSlected {margin-left: 416px;margin-top: -350px;}
#divDesign {width: 350px; margin-top: 40px;}
#divDim{margin: 40px 0px 0px 0px; width: 350px;}
#divSize{margin: 40px 0px 0px 0px; width: 350px;}
#divButtons{height:100px; margin-top: 20px; width:760px; text-align:center;}
#divClipProps {display : none;}