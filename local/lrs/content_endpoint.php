 ...
 * copied from webservice/pluginfile.php
 * with a small change to return a 401 header if token not passed.
 * Used particularly by Articulate Mobile player.
 *
 * @package    local_lrs
...
$token = optional_param('content_token', '', PARAM_ALPHANUM);
if (!empty($token)) {
