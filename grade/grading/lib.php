 ...
 * @param string|null $areaname the name of the gradable area
 * @return grading_manager
 */
function get_grading_manager($context_or_areaid = null, $component = null, $areaname = null) {
    global $DB;
    $gradingarea = null;
    ...
    } else if (!is_null($areaname)) {
        $manager->set_area($areaname);
    }
