...
$string['configselfgradelockout'] = 'Timeframe required between post and self grading';
...
$string['selfgradelockout'] = 'Self grade lockout';
$string['selfgradingwillopen'] = 'Self grading on this post will be available after {$a}';
