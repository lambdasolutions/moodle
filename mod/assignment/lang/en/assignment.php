...
$string['bulkupload_failed'] = 'Bulk upload of feedback file {$a} (failed) as no userid was found';
$string['bulkupload_locked'] = 'Bulk upload of feedback file {$a} (failed) as the grade was locked for this user';
$string['bulkupload_groupfailed'] = 'Bulk upload of feedback file {$a} (failed) as the marker wasn\'t able to mark this users groups';
...
$string['bulkuploaderror'] = 'The following files could not be uploaded as no user was found in your course matching these files:';
$string['bulkuploadlocked'] = 'The following files could not be uploaded as the grade for these users was locked:';
$string['bulkuploadnewfiles'] = '{$a} new feedback file(s) were uploaded';
$string['bulkuploadnogroups'] = 'This course uses separate groups, you don\'t have the capability to view all groups and are not a member in any groups so cannot submit feedback files to this course';
$string['bulkuploadgroupfailed'] = 'The following files could not be uploaded as you do not have the capabilities to mark these users groups:';
$string['bulkuploadrenamed'] = '{$a} new feedback file(s) were renamed as an existing feedback file was found';
$string['bulkuploadreplaced'] = '{$a} new feedback file(s) were replaced as an existing feedback file was found';
$string['bulkuploadskipped'] = '{$a} new feedback file(s) were skipped as an existing feedback file was found';
