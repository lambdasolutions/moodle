...
add_to_log($course->id, 'kalturapresentation', 'view all', "index.php?id=$course->id", '');

$strvideo        = get_string('modulename', 'kalturapresentation');
$strvideos       = get_string('modulenameplural', 'kalturapresentation');
$strsectionname  = get_string('sectionname', 'format_'.$course->format);
$strname         = get_string('name');
$strintro        = get_string('moduleintro');
$strlastmodified = get_string('lastmodified');

$PAGE->set_url('/mod/kalturapresentation/index.php', array('id' => $course->id));
$PAGE->set_title($course->shortname.': '.$strvideos);
$PAGE->set_heading($course->fullname);
$PAGE->navbar->add($strvideos);
echo $OUTPUT->header();

if (!$videos = get_all_instances_in_course('kalturapresentation', $course)) {
...
foreach ($videos as $video) {
    ...
    $table->data[] = array (
        ...
        format_module_intro('kalturapresentation', $video, $cm->id));
}
