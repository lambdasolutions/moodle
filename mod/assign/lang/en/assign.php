...
$string['configattemptreopenmethod'] = 'Determines how student submission attempts are reopened.';
$string['configblindmarking'] = 'Blind marking hides the identity of students to markers.';
$string['configmaxattempts'] = 'The maximum number of submissions attempts that can be made by a student.';
$string['configrequireallteammemberssubmit'] = 'If enabled, all members of the student group must click the submit button for this assignment before the group submission will be considered as submitted.';
$string['configsendlatenotifications'] = 'If enabled, graders (usually teachers) receive a message whenever a student submits an assignment late. Message methods are configurable.';
$string['configsendnotifications'] = 'If enabled, graders (usually teachers) receive a message whenever a student submits an assignment, early, on time and late. Message methods are configurable.';
$string['configshowrecentsubmissions'] = 'Everyone can see notifications of submissions in recent activity reports.';
$string['configsubmissiondrafts'] = 'If enabled, students will have to click a Submit button to declare their submission as final.';
$string['configteamsubmission'] = 'If enabled students will be divided into groups based on the default set of groups or a custom grouping.';
