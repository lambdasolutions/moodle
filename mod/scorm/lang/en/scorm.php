...
$string['aiccuserid_desc'] = 'The AICC standard for usernames is very restrictive compared with Moodle. If enabled this passes a numeric user id instead of the moodle username to the AICC package.
